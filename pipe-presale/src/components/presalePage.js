        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center mb-12">
            <div className="flex justify-center items-center mb-4">
              ...
              />
              <h1 className="text-4xl font-bold text-center">pIPe Meme Coin Presale</h1>
              <img 
                src="/api/placeholder/60/60" 
            ...
            <a 
              ...
              className="bg-blue-600 text-white px-6 py-2 rounded-full flex items-center hover:bg-blue-700 transition duration-300"
            >
          ...
          <div id="roadmap" className="bg-white shadow rounded-lg p-6 mb-12">
            <h2 className="text-2xl font-semibold mb-4">Roadmap</h2>
            <div className="relative">
              <div className="absolute left-1/2 h-full w-1 bg-blue-500 transform -translate-x-1/2"></div>
          ...
          <div id="tokenomics" className="bg-white shadow rounded-lg p-6 mb-12">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://t.me/pIPecoin" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700">
              <Send size={24} />
            </a>
            <a href="https://twitter.com/pIPecoin" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-600">
              <Twitter size={24} />
            </a>
            <a href="https://github.com/pIPecoin" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600">
              <Github size={24} />
            </a>
          </div>
        </div>
